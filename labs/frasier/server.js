const express = require("express"); //require express and save it to a variable named express

const app = express(); //create a variable named app, and set it equal to express()
...
app.get("/Scrappy", (req, res) => res.send("wood"));

app.listen(3000, () => {
  //have app listen on port 300
  console.log("Hello, Seattle. I'm listening..."); // once it's listening, log "Hello, Seattle. I'm listening..."
});
